	...
	@Test
		...
		public void testOperaciones() {
			try {
				...
				Persona persona1 = new Persona(); // persona1.setNombre("Andrea11111111111111111111111111111111111
													// 11111111111111111");
				...
				// Deberia haber 4 personas assertEquals(4,
				// personaDao.contadorPersonas());
	
				// Actualizamos la persona con id=1 Persona persona2 =
